...
export const deleteComment = (id) => axios.delete(`http://localhost:3030comments/${id}`);
export const upComment = (id, textComment) => axios.put(`http://localhost:3030comments/${id}`, textComment);
